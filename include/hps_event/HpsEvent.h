...
public:
     ...
     * @return A pointer to the {@link EcalCluster} object that was added.
     */
    EcalCluster*  addUncorEcalCluster();
...
private:
     ...
     */
    int svt_latency_state=0;
    
    /**
     * Flag indicating whether the SVT was open or closed.  It's set to 0 if
     * the SVT was open or 1 if it was closed.
     */
    int svt_position_state=0;
    
    int n_tracks=0;
    int n_gbl_tracks=0;
    int n_svt_hits=0;
    int n_ecal_clusters=0;
    int n_uncor_ecal_clusters=0;
    int n_ecal_hits=0;
    int n_fs_particles=0;
    int n_uc_v0_candidates=0;
    int n_uc_vc_candidates=0;
    int n_uc_moller_candidates=0;
    int n_bsc_v0_candidates=0;
    int n_bsc_moller_candidates=0;
    int n_tc_v0_candidates=0;
    int n_tc_moller_candidates=0;
    int n_mc_particles=0;
    int n_other_electrons=0;
};
